...
# end with the same letters as the animals name. For example, the great blue heron is bringing garlic naan and the chickadee is bringing chocolate cake.
#
# Write a function feast that takes the animals name and dish as arguments and returns true or false to indicate whether
